...
<body class="text-center bg-dark">
    ...
    <div class="container h-100 d-flex flex-column justify-content-center  opacity-translation">
        ...
        <div class="row justify-content-center my-3">
            <div class="col-auto">
                <a type="button" href="page.php"class="btn btn-outline-secondary btn-lg ">Comenzar</a>
            </div>
            <div class="col-auto">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body h5 lead">
                    ...
                    <p class="my-3">
                        ...
                        <a href="https://t.me/eacb2_bot" target="_blank" data-bs-placement="right" data-bs-toggle="tooltip" data-bs-title="@eacb2_bot" target="_blank" class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
                            Bot
                        </a>
