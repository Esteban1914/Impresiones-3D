<?php
    ...
    $sql = "CREATE TABLE user_validation (
        id INT(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    ...
    $sql = "CREATE TABLE filament_color (
        id INT(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    ...
    $sql = "CREATE TABLE filament_color_relation (
    ...
    $sql = "CREATE TABLE file_requests (
        id INT(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
        message TEXT,
