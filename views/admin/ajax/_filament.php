            ...
            <?php foreach($fliaments as $filament): ?>
                <tr>
                    ...
                    <th >
                        ...
                        <a title="Colores" class="bg-primary mx-2 text-light p-1 rounded-pill" href="filament_colors.php?filament_id=<?php echo $filament['id']?>&filament_name=<?php echo $filament['name']?>"><i class="bi bi-droplet"></i></a>
