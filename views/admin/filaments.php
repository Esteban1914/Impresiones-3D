...
<body class="text-center bg-dark text-light">
    ...
    <div class="container opacity-translation pt-5">
            ...
            <div class="col-auto ">
                <?php
                    function getOKMessage($key)
                    {
                        switch ($key) {
                            case 'add_filament':
                                return "Creado filamento";
                            case "delete_filament":
                                return "Eliminado filamento";
                            default:
        ...
        <div class="container">
            ...
            <div class="row m-5">
                <div class="display-5">Panel de Filamentos</div>
            </div>
            <div class="row justify-content-center">
                <div class="col-auto">
                    <a href="" data-bs-toggle="modal" data-bs-target="#modalAddFilament" class="btn btn-primary"><div class="h5">Nuevo Filamento</div></a>
                </div>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-dark">Nuevo Filamento</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body  text-dark">
                            <form action="../../includes/add_filament.php" method="post">
                                <div class="row justify-content-center">
                                    <div class="input-group mb-3">
                                        <div class="form-floating">
                                            <input  autocomplete="new-password" required name="name" type="text" class="form-control" id="input_filament" placeholder="Filamento">
                                            <label for="input_filament">Filamento</label>
                                            <div class="invalid-tooltip" id="id_inputusername_invalid">
                                                Nombre de filamento en uso 
                                            </div>
                                        </div>  
                                    </div> 
                                    <div class="input-group mb-3">
                                        <div class="form-floating">
                                            <input  required name="price" min="0" step="0.001" type="number" class="form-control" id="id_price"placeholder="Precio">
            ...
            <div class="row justify-content-center">
                <div class="col-auto">
                    <div class="d-flex" role="search">
                        <input oninput="getFilamentFilterTimer()" id="id_search" class=" text-center form-control me-2" type="search" placeholder="Filtrar por nombre" aria-label="Search">
                    </div>
                </div>
            </div>
    ...
    <script>
        function getFilamentFilterTimer()
        {
            clearTimeout(timer);
        ...
        function getFilamentFilter()
        {
            document.getElementById('id_data').className="d-none";
            document.getElementById('id_placeholder').className="d-block";
            fetch("./ajax/_filament.php"+(document.getElementById("id_search").value?"?filter_filament="+document.getElementById("id_search").value:""))
